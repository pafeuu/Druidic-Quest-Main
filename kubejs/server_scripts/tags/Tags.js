...
ServerEvents.tags('item', event => {
  ...
  event.add('immersive_weathering:bark',['arsdelight:flourishing_bark', 'arsdelight:vexing_bark', 'arsdelight:cascading_bark', 'arsdelight:blazing_bark'])
  ...
  event.add("minecraft:fence_gates",['wizards_reborn:arcane_wood_fence_gate', 'wizards_reborn:cork_bamboo_fence_gate', 'wizards_reborn:innocent_wood_fence_gate','immersive_weathering:charred_fence_gate', 'quark:nether_brick_fence_gate', 'twilightforest:mining_fence_gate', 'twilightforest:transformation_fence_gate', 'twilightforest:time_fence_gate', 'twilightforest:dark_fence_gate', 'twilightforest:mangrove_fence_gate', 'twilightforest:canopy_fence_gate', 'twilightforest:twilight_oak_fence_gate', 'ancient_aether:sakura_fence_gate', 'ancient_aether:highsproot_fence_gate', 'aether:skyroot_fence_gate', 'ars_nouveau:archwood_fence_gate', 'mynethersdelight:powdery_fence_gate', 'twilightforest:sorting_fence_gate', 'copycats:copycat_fence_gate', 'thermal:rubberwood_fence_gate'])
  event.add("handcrafted:pots",['twigs:magenta_silt_pot', 'twigs:cyan_silt_pot', 'twigs:orange_silt_pot', 'twigs:gray_silt_pot', 'twigs:pink_silt_pot', 'twigs:light_blue_silt_pot', 'twigs:yellow_silt_pot', 'twigs:black_silt_pot', 'twigs:silt_pot', 'twigs:blue_silt_pot', 'twigs:lime_silt_pot', 'twigs:brown_silt_pot', 'twigs:white_silt_pot', 'twigs:light_gray_silt_pot', 'twigs:red_silt_pot', 'twigs:green_silt_pot', 'twigs:purple_silt_pot','minecraft:flower_pot', 'minecraft:decorated_pot'])
  ...
  event.add("waystones:waystones",['waystones:blackstone_waystone', 'waystones:end_stone_waystone', 'waystones:deepslate_waystone'])
